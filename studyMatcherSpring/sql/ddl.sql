...
create table study (study_id bigint not null, level varchar(255), city varchar(255), gu varchar(255), name varchar(255), type varchar(255), study_page_id bigint, primary key (study_id));
...
create table study_join (study_join_id bigint not null, status varchar(255), member_id bigint, study_id bigint, primary key (study_join_id));
